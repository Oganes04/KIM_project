            ...
            <div className="news_wrapper">
               	...
               	<div className="news_list">
                	<div className="news_list-item">
                		<div className="title">
                            ...
                            <div className="title__description">
	                            Кафедра компьютерной инженерии и моделирования Физико-технического института Крымского
	                            федерального университета им. В.И. Вернадского стала участником академической программы ООО
	                            «СВД ВС», в рамках которой получила современное российское программное обеспечение, которое
	                            позволит готовить квалифицированных специалистов в области технологий реального времени и
	                            встраиваемых систем уже с сентября этого года.
                            </div>
                        </div>
                	...
                	<div className="news_list-item">
                        ...
                        <div className="details">
                            <div className="details__date">31.03.2023</div>
                            <div className="details__theme">css_news</div>
                        </div>
                	</div>
                	...
                	<div className="news_list-item">
                        ...
                        <div className="details">
                            <div className="details__date">06.07.2021</div>
                            <div className="details__theme">css_news</div>
                        </div>
                	</div>
                </div>
